...
from frontend.app.models.quizzes import Quiz, Questao, Alternativa, TentativaQuiz, RespostaQuiz
from frontend.app.models.progresso import ProgressoLicao, NivelUsuario, Conquista, ConquistaUsuario, Notificacao
